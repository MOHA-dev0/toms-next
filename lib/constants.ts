...
export const NAV_ITEMS = {
  admin: [
    ...
    { type: 'link', path: '/other-services', label: 'الخدمات الأخرى', icon: 'Layers' },
    { type: 'link', path: '/companies', label: 'الشركات', icon: 'Building2' },
    { type: 'link', path: '/agents', label: 'الوكلاء', icon: 'Briefcase' },
    { type: 'link', path: '/employees', label: 'الموظفين', icon: 'Users' },
